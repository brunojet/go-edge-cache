module github.com/brunojet/go-edge-cache
...
require (
	...
	github.com/brunojet/go-infra-adapters/v4 v4.2.1
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudfront v1.64.2 // indirect
